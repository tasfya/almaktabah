...
export default function SocialLinks() {
  return (
    <div className="flex items-center justify-start space-x-4 space-x-reverse">
      ...
      <Link href="https://telegram.org" className="text-gray-600 hover:text-gray-900">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
          height="18"
      ...
      <Link href="https://soundcloud.com" className="text-gray-600 hover:text-gray-900">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
          height="18"
          ...
          strokeLinejoin="round"
        >
          <path d="M3 18c2.5 0 2.5-6 5-6 2.5 0 2.5 6 5 6 2.5 0 2.5-6 5-6 2.5 0 2.5 6 5 6"></path>
        </svg>
      ...
      <Link href="https://google.com" className="text-gray-600 hover:text-gray-900">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
          height="18"
